...
function Board(canvas) {
  ...
  this.jean = this.createJean();
  this.lazer = this.createLazer();
  get$$document().get$window().setInterval($wrap_call$0(this.get$redraw()), (4));
}
...
Board.prototype.createClouds = function() {
  this.cloud1 = new Cloud(this, (100), (-20), (70), (70));
  this.cloud2 = new Cloud(this, (600), (-293), (70), (70));
  this.cloud3 = new Cloud(this, (800), (-90), (70), (70));
  this.cloud4 = new Cloud(this, (500), (-170), (70), (70));
  this.cloud5 = new Cloud(this, (700), (-240), (70), (70));
  this.cloud6 = new Cloud(this, (300), (-350), (70), (70));
}
Board.prototype.createPlane = function() {
...
Board.prototype.drawJeans = function() {
  this.jean1.draw();
  this.jean2.draw();
  this.jean3.draw();
}
...
Board.prototype.clear$_ = function() {
...
Lazer.prototype.draw = function() {
  this.y--;
  this.board.context.beginPath();
  this.board.context.fillStyle = "green";
  this.board.context.fillRect(this.x, this.y, this.width, this.height);
  this.board.context.closePath();
  this.board.context.stroke();
  if (this.x > this.jean1.x && this.x < this.jean1.x + this.jean1.width && this.y > this.jean1.y && this.y < this.jean1.y + this.jean1.height) {
    this.jean1.visible = false;
  }
  if (this.x > this.jean2.x && this.x < this.jean2.x + this.jean2.width && this.y > this.jean2.y && this.y < this.jean2.y + this.jean2.height) {
    this.jean2.visible = false;
  }
  if (this.x > this.jean3.x && this.x < this.jean3.x + this.jean3.width && this.y > this.jean3.y && this.y < this.jean3.y + this.jean3.height) {
    this.jean3.visible = false;
  }
}
Lazer.prototype.get$draw = function() {
  return this.draw.bind(this);
}
function Cloud(board, x, y, width, height) {
  this.reappear = true;
  this.board = board;
  this.x = x;
  this.y = y;
  this.width = width;
  this.height = height;
  this.imageData2 = get$$document().query("#cloud");
  get$$document().get$window().setInterval($wrap_call$0(this.get$move()), (4));
}
Cloud.prototype.move = function() {
  this.y++;
  this.random = (Math.random() * (900)).toInt();
...
Cloud.prototype.get$move = function() {
  return this.move.bind(this);
}
Cloud.prototype.draw = function() {
  this.board.context.beginPath();
  this.board.context.fillStyle = "white";
  this.board.context.drawImage(this.imageData2, this.x, this.y, this.width, this.height);
  this.board.context.closePath();
  this.board.context.stroke();
}
...
Jean.prototype.move = function() {
  this.y = this.y + (2);
  this.x = this.x + (2);
  this.random2 = (Math.random() * (900)).toInt();
  if (this.y >= this.board.height) {
    this.reappear = true;
  }
  else {
...
Jean.prototype.get$move = function() {
  return this.move.bind(this);
}
Jean.prototype.draw = function() {
  this.board.context.beginPath();
  if (this.visible) {
    this.board.context.drawImage(this.imageData3, this.x, this.y, this.width, this.height);
  }
  else {
    this.board.context.drawImage(this.imageData4, this.x, this.y, this.width, this.height);
  }
  this.board.context.closePath();
  this.board.context.stroke();
}
